...
- **Context to Concept: Concept Encoding in In-context Learning**
  *Jinyeop Song*, Sumin Han, P. Argawal, Jeffrey Gore
  **ICML 2025 Spotlight (Top 2.5%)**
  [arXiv](https://arxiv.org/abs/2412.12276)
...
- **Estimating Empowerment of Language Model Agents**
  *Jinyeop Song*, Jeff Gore, Max Kleiman-Weiner
  arXiv preprint
  [arXiv](https://arxiv.org/abs/2509.22504)

- **Reconciling Kaplan and Chinchilla Scaling Laws**
  Tim Pearce, *Jinyeop Song*
  **TMLR 2024**
  [arXiv](https://arxiv.org/abs/2406.12907)

- **A Resource Model for Neural Scaling Law**
  *Jinyeop Song*, Ziming Liu, Max Tegmark, Jeff Gore
  **ICLR 2024 BGPT Workshop**
  [arXiv](https://arxiv.org/abs/2402.05164)
...
- **MethylGPT: Foundational GPT-like Model for Human Methylation Data**
  Alex Ying, *Jinyeop Song*, Haoran Cui, et al.
  *Under review in Nature Methods*
  [bioRxiv](https://www.biorxiv.org/content/10.1101/2024.10.30.621013v2)
...
- **Probing the Embedding Space of Protein Foundation Models through Intrinsic Dimension Analysis**
  Seungwoo Yang, Jiho Nam, Tomas Perez, *Jinyeop Song*, Xiao Du, Rafael Gomez-Bombarelli
